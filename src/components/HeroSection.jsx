...
const HeroSection = ({ onSearch }) => {
  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-24">
      ...
      <div
        className="absolute top-[-80px] left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full blur-[120px] pointer-events-none"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-0 left-[10%] w-[300px] h-[200px] rounded-full blur-[80px] pointer-events-none"
        style={{ background: 'rgba(236,72,153,0.08)' }}
      />
      <div
        className="absolute bottom-0 right-[10%] w-[300px] h-[200px] rounded-full blur-[80px] pointer-events-none"
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-6 animate-slide-up">
          ...
          <p className="text-slate-400 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            Explore a curated collection of stunning 4K wallpapers — gaming,
            anime, nature, cars & more.
          </p>
